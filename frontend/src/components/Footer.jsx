...
import frameworksLogo from "../assets/content/frameworks-development-icon-cream.png";

const Footer = () => {
	return (
		<div
			className='relative h-fit w-screen flex flex-col justify-between bg-base *:text-background-primary pt-12 pb-4 px-4 gap-y-8 lg:gap-y-0 border-t border-primary-dark'>
			<div className='relative flex justify-between'>
				<div className='flex flex-col h-36 justify-between'>
					<img src={frameworksLogo} alt='Frameworks Design Logo' className="w-fit h-12"  />
					<div className='flex gap-x-2 justify-end items-center lg:justify-start'>
						<a
