...
const AboutCard = ({ title, text, icon }) => {
	return (
		<div
			className='flex flex-col justify-between items-center h-90 min-w-60 w-full max-w-80 text-center py-9 px-6 border-t border-base md:w-full xl:h-90 xl:w-full'>
