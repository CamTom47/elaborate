...
const ServiceSection = () => {
	const svgObject = {
		...
		webDev: (
			<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
				<g fill='none' stroke='currentColor' stroke-width='1.5'>
					<path stroke-linecap='round' stroke-linejoin='round' d='M2 21h15m4 0h1' />
		...
		mobileDev: (
			<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
				<g fill='none' stroke='currentColor' stroke-width='1.5'>
					<path stroke-linecap='round' stroke-linejoin='round' d='m12 16.01l.01-.011' />
	...
	return (
		<div className='service-section'>
			<div className='header-container'>
				<h1>Build Flexible and Intuitive Products With Our Software Solutions</h1>
			</div>
			<div className='service-grid'>
				<ServiceCard
					title={"Web Design"}
					description={"Design beautiful websites optimized to gain you maximum exposure"}
					url='/services/website-design-nav'
					icon={svgObject.webDesign}></ServiceCard>
				<ServiceCard
					title={"Web Development"}
					description={"Develop applications to meet your needs using Front-end, Back-end, and Full-Stack toolsets"}
					url='/services/web-dev-nav'
					icon={svgObject.webDev}></ServiceCard>
				<ServiceCard
					title={"Mobile Development"}
					description={"Develop native or hybrid mobile solutions"}
