	...
	return (
		<div className=' flex flex-col w-full h-fit bg-blue-500 px-80 py-20 items-center'>
			<div className='flex flex-col w-full items-center '>
				...
				<div className='w-full divide-blue-300'>
					{/* Planning Section */}
					<div className=' flex flex-col items-center w-full my-10 py-10'>
						<h2 className='text-4xl text-white font-semibold'>Planning</h2>
						<div className='flex flex-col justify-around gap-y-20 text-white py-4 '>
							...
							<div className='flex text-white justify-around [&_p]:text-center border-y-2 border-blue-300'>
								<div className='flex flex-col justify-around items-center size-80 p-4'>
					...
					{/* Design section */}
					<div className=' flex flex-col items-center w-full my-10 py-10'>
						<h2 className='text-4xl text-white font-semibold'>Design</h2>
						<div className='flex flex-col justify-around gap-y-4 text-white text-2xl py-4 '>
					...
					{/* Implementation */}
					<div className=' flex flex-col items-center w-full my-10 py-10'>
						<h2 className='text-4xl text-white font-semibold'>Implementation</h2>
						<div className='flex flex-col justify-around gap-y-4 text-white text-2xl pt-4 '>
							<p className='text-center'>
								By combining information from the planning and design phases, our team will begin to bring your project
								to life.
							</p>
							<div className='flex text-white justify-around [&_p]:text-center border-y-2 border-blue-300'>
								<div className='flex flex-col justify-between items-center size-80 p-4'>
					...
					{/* Testing Section */}
					<div className=' flex flex-col items-center w-full my-10 py-10'>
						<h2 className='text-4xl text-white font-semibold'>Testing</h2>
						<div className='flex flex-col justify-around gap-y-4 text-white text-2xl py-4 '>
							<p className='text-center'>
					...
					{/* Deployment Section */}
					<div className=' flex flex-col items-center w-full my-10 py-10'>
						<h2 className='text-4xl text-white font-semibold'>Deployment</h2>
						<div className='flex flex-col justify-around gap-y-4 text-white text-2xl py-4 '>
							<p className='text-center'>
							...
							<div className='flex text-white justify-around [&_p]:text-center border-y-2 border-blue-300'>
								<div className='flex flex-col justify-between items-center size-80 p-4'>
									...
									<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 15a6 6 0 1 0-5.743-4.257L9 11l-5.707 5.707a1 1 0 0 0-.293.707V20a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1a1 1 0 0 1 1-1a1 1 0 0 0 1-1a1 1 0 0 1 1-1h.586a1 1 0 0 0 .707-.293L13 15l.257-.257A6 6 0 0 0 15 15m2-6a2 2 0 0 0-2-2"/></svg>

									<p className='text-lg'>All applicable accounts necessary for your project to run will be transferred into your full control</p>
								</div>
								<span className='border-1 border-blue-300'></span>
								<div className='flex flex-col justify-between items-center size-80 p-4'>
					...
					{/* Deployment Section */}
					<div className=' flex flex-col items-center w-full my-10 py-10'>
						<h2 className='text-4xl text-white font-semibold'>Maintenance</h2>
						<div className='flex flex-col justify-around gap-y-4 text-white text-2xl py-4 '>
							<p className='text-center'>
								Post Deployment project maintenance will vary project to project based on agreed upon terms upon contract execution.
							</p>
						</div>
					</div>
				</div>
