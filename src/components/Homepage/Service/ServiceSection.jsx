...
import ServiceScroller from "../../Services/ServiceScroller";
...
const ServiceSection = () => {
	...
	return (
		<div className='flex flex-col h-screen w-full justify-around items-center px-20 bg-slate-900 rounded-md p-20'>
			...
			<div className='grid grid-cols-4 gap-12 w-full'>
				...
				<ServiceCard title={"Application/Website Redesign"} description={"We remake bad stuff to good!"} url="/services/app-redesign-nav" icon={svgObject.redesign}></ServiceCard>
			</div>
			<Link
				to='/services'
